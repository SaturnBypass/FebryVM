...
import com.febry.vm.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.febry.vm.AppConfig.GEOIP_PRIVATE
import com.febry.vm.AppConfig.GEOSITE_PRIVATE
import com.febry.vm.AppConfig.TAG_DIRECT
...
import com.febry.vm.dto.entities.SubscriptionItem
import com.febry.vm.dto.V2rayConfig
import com.febry.vm.enums.EConfigType
import com.febry.vm.enums.Language
import com.febry.vm.enums.RoutingType
import com.febry.vm.enums.VpnInterfaceAddressConfig
import com.febry.vm.handler.MmkvManager.decodeAllServerList
import com.febry.vm.handler.MmkvManager.decodeServerConfig
import com.febry.vm.handler.MmkvManager.decodeSubsList
import com.febry.vm.handler.MmkvManager.decodeSubscription
import com.febry.vm.handler.MmkvManager.encodeSubscription
import com.febry.vm.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    fun getRemoteDnsServers(): List<String> {
        // If DNS over HTTPS is enabled, prepend the DoH URL
        if (MmkvManager.decodeSettingsBool(AppConfig.PREF_DNS_OVER_HTTPS, false)) {
            val dohUrl = MmkvManager.decodeSettingsString(AppConfig.PREF_DNS_OVER_HTTPS_URL, "https://cloudflare-dns.com/dns-query")
            if (!dohUrl.isNullOrBlank()) return listOf(dohUrl)
        }
        val remoteDns =
