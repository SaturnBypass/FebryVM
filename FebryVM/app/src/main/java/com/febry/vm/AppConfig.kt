...
object AppConfig {
    ...
    const val PREF_DNS_OVER_HTTPS = "pref_dns_over_https"
    const val PREF_DNS_OVER_HTTPS_URL = "pref_dns_over_https_url"
    const val PREF_AUTO_SWITCH_SERVER = "pref_auto_switch_server"
    const val PREF_SCHEDULED_SUB_UPDATE = "pref_scheduled_sub_update"
    const val PREF_SCHEDULED_SUB_UPDATE_INTERVAL = "pref_scheduled_sub_update_interval"
    const val SCHEDULED_SUB_UPDATE_TASK = "scheduled_sub_update_task"
    ...
    const val APP_URL = "$GITHUB_URL/2dust/FebryVM"
    const val APP_API_URL = "https://api.github.com/repos/2dust/FebryVM/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/FebryVM/master/CR.md"
    ...
    const val RAY_NG_CHANNEL_NAME = "FebryVM Background Service"
