...
import com.febry.vm.dto.GroupMapItem
import com.febry.vm.dto.entities.ServersCache
import com.febry.vm.dto.entities.SubscriptionCache
import com.febry.vm.dto.SubscriptionUpdateResult
import com.febry.vm.dto.TestServiceMessage
import com.febry.vm.extension.matchesPattern
import com.febry.vm.extension.toastError
import com.febry.vm.extension.toastSuccess
...
import com.febry.vm.handler.SpeedtestManager
import com.febry.vm.util.LogUtil
import com.febry.vm.util.MessageUtil
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /**
     * Auto-switch to the server with the lowest ping after test.
     */
    private fun autoSwitchToBestServer() {
        val allGuids = if (subscriptionId.isEmpty())
            MmkvManager.decodeSubsList().flatMap { MmkvManager.decodeServerList(it) }
        else
            MmkvManager.decodeServerList(subscriptionId)
    ...
    fun onTestsFinished() {
        viewModelScope.launch(Dispatchers.Default) {
            ...
            if (MmkvManager.decodeSettingsBool(AppConfig.PREF_AUTO_SWITCH_SERVER, false)) {
