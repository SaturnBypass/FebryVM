...
import com.febry.vm.AppConfig.LOOPBACK
import com.febry.vm.BuildConfig
import com.febry.vm.contracts.ServiceControl
import com.febry.vm.contracts.Tun2SocksControl
...
import com.febry.vm.util.MyContextWrapper
...
//    }
    ...
    private fun configurePlatformFeatures(builder: Builder) {
        ...
        // Kill Switch: block all connections if VPN is disconnected
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            if (MmkvManager.decodeSettingsBool(AppConfig.PREF_KILL_SWITCH, false)) {
